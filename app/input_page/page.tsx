    ...
    <div className="min-h-screen bg-background max-w-[1000px] mx-auto">
      <div className="container mx-auto p-6 space-y-8">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-2">
            <Label htmlFor="ssn" className="text-lg font-medium">
              SSN
            </Label>
            <input
              id="ssn"
          ...
          <div className="space-y-4">
            <Label htmlFor="input-type" className="text-lg font-medium">
              Choose Input Type
            </Label>
            <RadioGroup
              id="input-type"
          ...
          {inputType === "text" ? (
            <div className="space-y-2">
              <Label htmlFor="patient-info" className="text-lg font-medium">
